...
public class Gson03 extends Application
{
	...
	private void obj2Json()
	{
		...
		Type type = new TypeToken<List<TeamAbs>>() {}.getType();
		...
		gsonBuilder.registerTypeAdapter( TeamAbs.class, new TeamElementAdapter() );
	...
	private void json2ListTeam()
	{
		...
		Type type = new TypeToken<ArrayList<TeamAbs>>() {}.getType();
		List<TeamAbs> teamList = gson.fromJson( taJSon.getText(), type );
	...
	private void cloneTest()
	{
		...
		List<TeamAbs> teamListClone = (List<TeamAbs>)((ArrayList<TeamAbs>)teamList).clone();
		TeamAbs tigersClone = null;
		try
		{
