...
public class Mongo01 
{
	public static void main( String[] args )
	{
		try{  
			...
			/**/
			String driverPath1 = "C:\\myjava\\MiluJavaSample.git\\MiluJavaSample\\loader\\mongo\\mongo-java-driver-3.0.3.jar";
			URL url1 = Paths.get(driverPath1).toUri().toURL();
			System.out.println( url1 );
			String driverPath2 = "C:\\myjava\\MiluJavaSample.git\\\\MiluJavaSample\\loader\\mongo\\unityjdbc.jar";
